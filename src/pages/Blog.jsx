...
function Blog() {
  ...
  return (
    <section className="w-full flex flex-col items-center justify-center gap-6 px-6 sm:px-12 pt-10 sm:pt-20 bg-lightMode dark:bg-darkMode text-softDark dark:text-gainsboro relative">
      <div className="max-w-4xl w-full flex flex-col sm:flex-row items-center justify-between gap-2.5">
        <div className="w-full sm:w-1/2">
          <h2 className="text-3xl font-bold dark:text-yellow-600 animated animatedFadeInDown fadeInDown">
            Blog
          </h2>
          <p className="mt-2 text-gray-800 dark:text-[#BFBFBF] font-normal animated animatedFadeInUp fadeInUp">
            ...
            <Link
              ...
              className="text-yellow-600 dark:text-cyan-500 font-medium"
            >
              Koda va hayot
            </Link>
          </p>
        ...
        <div className="w-full flex flex-col py-5">
          {blogData.map((item) => (
            ...
            >
              ...
              {/* Matn qismi */}
              <div className="w-full sm:w-2/3 h-full pl-0 sm:pl-4 mt-3 sm:mt-0">
                ...
                <div className="mt-3 flex flex-col justify-end">
                  ...
                  <Link
                    to={`/blog/${item.id}`}
                    className="inline-block text-sm text-blue-700 dark:text-sky-500 hover:underline hover:opacity-80 transition duration-200"
                  >
                    Ko'proq o'qish
                  </Link>
                </div>
