  ...
  return (
    <section className="w-full flex flex-col-reverse sm:flex-row items-center justify-center gap-5 px-5 py-5 sm:py-20">
      <div className="flex flex-col items-start justify-center">
        ...
        <p
          className="font-medium text-sm text-gray-600 dark:text-[#BFBFBF] mt-2 animated animatedFadeInUp fadeInUp"
        ...
        <div className="mt-5 flex gap-4 text-2xl">
          {linksData &&
            linksData.map((item) => <SocialLink item={item} key={item.id} />)}
        </div>
        <div className="mt-4">
          <p
            className="font-medium text-sm text-gray-600 dark:text-[#BFBFBF] animated animatedFadeInUp fadeInUp"
      ...
      <div className="size-64 md:size-96 flex items-center justify-center animated animatedFadeInUp fadeInUp">
        <img
          src={myPhoto}
